<script>
import {getBaseUrl} from "@/../public/static/js/functions.js"
...
export default {
  ...
  methods: {
    ...
    initInfo() {
      ...
      if (this.ACTION == "setting_kefu_list") {
